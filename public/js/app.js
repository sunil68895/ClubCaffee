...
var deleteCart = document.querySelector('#deleteCart');
...
function deleteCartItems() {
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/delete-cart').then(function (req, res) {
    notie__WEBPACK_IMPORTED_MODULE_2___default().alert({
      text: 'Cart deleted'
    });
  });
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp == order.status) {
      stepCompleted = false;
      time.innerHTML = moment__WEBPACK_IMPORTED_MODULE_1___default()(order.updatedAt).format('hh:mm A');
      status.appendChild(time);
      if (status.nextElementSibling) status.nextElementSibling.classList.add('current');
    }
  });
}
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51JS2AhSJBypHtZf3laLQ8z1IgNLyX5q8NBATICARXIVGF752U1JmiTLzJtsmD1CmPVDIvrazK1uzWHmJEDTTa4UR00ENCPJY8l');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizzaplace"] = self["webpackChunkpizzaplace"] || [];
